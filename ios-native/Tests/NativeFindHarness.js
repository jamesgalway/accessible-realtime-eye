...
assert.equal(P.approach({...o,x:0.39}),'left');
assert.equal(P.approach({...o,x:0.61}),'right');
assert.equal(P.approach({...o,x:0.56},'right'),'right');
assert.equal(P.approach({...o,x:0.54},'right'),'forward');
