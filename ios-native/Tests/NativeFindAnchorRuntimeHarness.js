...
(async()=>{
 ...
 console.log('PASS: first announcement includes synchronized distance/height context; off-screen anchor stays local; AR interruption pauses; near handover requires centered target; tighter correction');
