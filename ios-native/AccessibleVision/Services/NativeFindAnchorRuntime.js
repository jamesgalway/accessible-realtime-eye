(() => {
  ...
  let selected=false,enabled=false,latest=null,current=null,counter=0,timer=null,oldTick=null,exitTimer=null;
  ...
  function stopFeedback(){
    ...
    exitTimer=setInterval(()=>{
      const r=appState.geminiReminder;
      if(current||document.hidden||Date.now()-started>15000||(destination&&destination!==r)){
        clearInterval(exitTimer);exitTimer=null;return;
      }
